...
public class ReloadRetractPistonCommand extends CommandBase {
  ...
  public ReloadRetractPistonCommand(ReloadSubsystem pneumatics) {
  ...
  public void execute() {
    ...
    reloadSubsystem.retractPiston(); //This is the command to execute -- extend the 

    System.out.println("Retracting Slider Piston!");
